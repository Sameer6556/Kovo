        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-richblack-5">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">
              Kovo is at the forefront of driving innovation in online
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-10">
              <h1 className="text-4xl font-semibold text-richblack-5 lg:w-[70%] ">
                Our Founding Story
              </h1>
            ...
            <div>
              <img
                src={FoundingStory}
                alt="Kovo's founding story"
                className="rounded-2xl border border-richblack-700 object-cover shadow-card"
              />
            </div>
          </div>
